...
Entry point for any TanStack-shaped question in dean-stack. The framework is TanStack Start running in **SPA mode with full prerender** for GitHub Pages — there is no runtime server in production. This skill exists to dispatch; sub-skills carry the rules.
