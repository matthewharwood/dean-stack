...
// │ 3. The `1..12` literal union in this file's `Round` type AND in the         │
// │    matching schemas (RoundIndicatorPropsSchema.round, etc.) gets extended   │
// │    to include the new literal.                                              │
...
// │ 5. RoundIndicator's "of 12" footer text — update when adding rounds.        │
